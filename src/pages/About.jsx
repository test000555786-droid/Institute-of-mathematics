...
export default function About() {
  return (
    <>
      {/* Hero */}
      <section className="relative w-full min-h-[45vh] md:h-[50vh] lg:h-[60vh] flex flex-col justify-center bg-cover bg-center bg-no-repeat z-0" style={{ backgroundImage: "url('/images/heroes/hero-about.png')" }}>
        ...
        <div className="container-main relative z-10 pt-16">
